...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20231116191947_mig_7")]
    partial class mig_7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseCourseVideoFile", b =>
                {
                    b.Property<int>("CourseVideoFilesId")
                        .HasColumnType("int");

                    b.Property<int>("CoursesId")
                        .HasColumnType("int");

                    b.HasKey("CourseVideoFilesId", "CoursesId");

                    b.HasIndex("CoursesId");

                    b.ToTable("CourseCourseVideoFile");
                });
            ...
            modelBuilder.Entity("CourseCourseVideoFile", b =>
                {
                    b.HasOne("EntityLayer.Concrete.File.CourseVideoFile", null)
                        .WithMany()
                        .HasForeignKey("CourseVideoFilesId")
